...
public class AdapterParentSpecials extends BaseExpandableListAdapter {
    ...
    private List<com.apitap.model.storeFrontSpecials.RESULTItem> listParent;
    private List<PCItem> listChild;

    public AdapterParentSpecials(Context context,
                                 List<com.apitap.model.storeFrontSpecials.RESULTItem> result,
    ...
    public void customNotify(ArrayList<com.apitap.model.storeFrontSpecials.RESULTItem> resultItems) {
