...
import com.apitap.app.BuildConfig;
import com.apitap.app.model.bean.DtoDefaultValues;
import com.apitap.app.model.bean.ShoppingCompBean;
...
//                + dataPlana + "]}";
    ...
    public static String makeJsonUserSignup(Activity context,
        ...
        try {
            ...
            param.put("114.13", Utils.convertStringToHex(addressSecondLine));
...
*/
    ...
    public static String getMessageProduct(Activity context, String productId,String messageId) {
        String parametersToCall = "";
        try {
            JSONObject obj = new JSONObject();
            obj.put("192", Constants.KEY_DEFAULT);
            ...
            JSONObject obj_param = new JSONObject();
            obj_param.put("53", ATPreferences.readString(context, Constants.KEY_USERID));
            obj_param.put("114.150", messageId); // confirm hardcoded or dynamic
        ...
        if (BuildConfig.DEBUG)
            Log.d(TAG, "getMessageProduct---" + parametersToCall);

        Logger.addRecordToLog("getMessageProduct" + parametersToCall);
        return parametersToCall;
    }
...
//            obj_param.put("53", ATPreferences.readString(context, Constants.KEY_USERID));
    ...
    public static String makeJsonAllMessages(Activity context) {
        ...
        try {
            ...
            objParam.put("53", ATPreferences.readString(context, Constants.KEY_USERID));
            objParam.put("114.9", "true");
            obj1.put("PARAM", objParam);

            JSONArray filterArray = new JSONArray();
            JSONObject filterObj = new JSONObject();
            filterObj.put("114.179", ATPreferences.readString(context, Constants.KEY_USERID));
            filterObj.put("operator", "eq");
            filterArray.put(filterObj);
            obj1.put("FILTER", filterArray);
            ...
            limitsObj.put("120.2", "0");
            limitsObj.put("120.3", "10");
//            obj1.put("LIMITS", limitsObj);

            obj1.put("ORDER", "114.138-DESC");
...
//        Logger.addRecordToLog(parametersToCall);
    ...
    public static String makeJsonReorder(Activity context, String invoiceId) {
        ...
        if (BuildConfig.DEBUG)
            Log.d(TAG, "makeJsonReorder---" + parametersToCall);
    ...
    public static String makeJsonUnreadMessages(Activity context) {
        ...
        if (BuildConfig.DEBUG)
                Log.d(TAG, "makeJsonUnreadMessages---" + parametersToCall);
    ...
    public static String makeMessageRead(Activity context, String messageId) {
        ...
        if (BuildConfig.DEBUG)
            Log.d(TAG, "makeMessageRead---" + parametersToCall);
