...
/**
 * Created by Shami on 24/1/2019.
 */

public class FilterCategoryNewBean {
    ...
    public class CA {
        ...
        public List<CA_> getCA() {
            return cA;
        }

        public void setCA(List<CA_> cA) {
            this.cA = cA;
        }
    ...
    public class CA_ {
        ...
        public List<CA__> getCA() {
            return cA;
        }

        public void setCA(List<CA__> cA) {
            this.cA = cA;
        }
    ...
    public class CA__ {
        ...
        public List<CA___> getCA() {
            return cA;
        }

        public void setCA(List<CA___> cA) {
            this.cA = cA;
        }
    ...
    public class CA___ {
        ...
        public List<CA____> getCA() {
            return cA;
        }

        public void setCA(List<CA____> cA) {
            this.cA = cA;
        }
    ...
    public class CA____ {
        ...
        public List<CA_____> getCA() {
            return cA;
        }

        public void setCA(List<CA_____> cA) {
            this.cA = cA;
        }

    }

    public class CA_____ {
