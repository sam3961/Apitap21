...
public class DetailsBean implements Parcelable{
    ...
    public ArrayList<com.apitap.app.model.bean.items.LocationBean> getLocationList() {
        return locationList;
    }

    public void setLocationList(ArrayList<com.apitap.app.model.bean.items.LocationBean> locationList) {
