...
import com.apitap.app.model.bean.SearchFavoritesBean;
...
public class SearchFavoritesManager {

    private static final String TAG = SearchFavoritesManager.class.getSimpleName();
    public SearchFavoritesBean searchFavoritesBean;

    public void searchFavorites(Context context, String params, int key) {
    ...
    private class ExecuteApi extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... param) {
            ...
            Log.d(TAG, "search_favorite_result " + response);
            return response;
        }
    ...
    private class ExecuteSearchApi extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            super.onPostExecute(s);
            Log.e("TAG","Search Favorite Results: " + s);
