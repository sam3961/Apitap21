...
import com.apitap.app.model.bean.guestActivity.GuestActivityBean;
import com.apitap.app.model.bean.guestLogin.GuestLoginBean;
...
//                        if (imageURLobj.getString("_114_3").contains(" ")) {
                        ...
                        String fullName = imageURLobj.optString("_114_53");
