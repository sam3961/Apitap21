package com.apitap.app.views.streaming;
 ...
 */
public abstract class ConnectionsFragment extends BaseFragment {
    ...
    private static final String[] REQUIRED_PERMISSIONS_12 =
            new String[]{
//                    Manifest.permission.BLUETOOTH,
//                    Manifest.permission.BLUETOOTH_ADMIN,
                    Manifest.permission.ACCESS_WIFI_STATE,
    ...
    private String TAG = ConnectionsFragment.class.getSimpleName();
    ...
    private final ConnectionLifecycleCallback mConnectionLifecycleCallback =
            new ConnectionLifecycleCallback() {
                ...
                public void onConnectionInitiated(String endpointId, ConnectionInfo connectionInfo) {
                    ...
                    Endpoint endpoint = new Endpoint(endpointId, connectionInfo.getEndpointName(), true);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mConnectionsClient = Nearby.getConnectionsClient(requireContext());
    }
    ...
    protected void startAdvertising() {
        mIsAdvertising = true;
        SharedPreferences pref2 = getActivity().getSharedPreferences("AIO_PREF", MODE_PRIVATE);
        final String localEndpointName = pref2.getString("nick_name", "");
                ...
                .addOnSuccessListener(
                        new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void unusedResult) {
                                logV("Now advstartAdvertisingertising endpoint " + localEndpointName);
                        ...
                        new EndpointDiscoveryCallback() {
                            ...
                            public void onEndpointFound(String endpointId, DiscoveredEndpointInfo info) {
                                ...
                                if (getServiceId().equals(info.getServiceId())) {
                                    Endpoint endpoint = new Endpoint(endpointId, info.getEndpointName(),true);
    ...
    protected String[] getRequiredPermissions() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            return REQUIRED_PERMISSIONS_12;
        } else
    ...
    public static class Endpoint {
        ...
        public Endpoint(@NonNull String id, @NonNull String name, @NonNull Boolean active) {
            this.id = id;
            this.name = name;
            this.active = active;
        }
