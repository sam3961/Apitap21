...
import com.apitap.app.model.CacheManager;
import com.apitap.app.model.Constants;
import com.apitap.app.model.Utils;
import com.apitap.app.model.bean.ProductDetailsBean;
...
public class FullScreenImage extends AppCompatActivity implements PlaybackPreparer, VideoRendererEventListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        collapse = (FrameLayout) findViewById(R.id.collapse);
        collapse_img = (ImageView) findViewById(R.id.collapse_img);
        ...
        next_img = (ImageView) findViewById(R.id.next_arrow);
        ...
        adId = (String) extras.getString("ad_id");
        ...
        if (extras.containsKey("detailsArray")) {
            ...
            img_selcted_postion = (Integer) extras.getInt("img_position");
            if (detailsArray != null && detailsArray.size() > 0) {
                ...
                try {
                    ...
                    URL url = new URL(ATPreferences.readString(this, Constants.KEY_IMAGE_URL) +
...
//                    }
        ...
        TrackSelector trackSelector = new DefaultTrackSelector(this, adaptiveTrackSelectionFactory);
...
//        player.addVideoDebugListener(this);
    ...
    private MediaSource buildMediaSource(Uri videoUri) {
        return new ProgressiveMediaSource.Factory(new CacheDataSourceFactory(this, 100 * 1024 * 1024, 5 * 1024 * 1024))
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.back_arrow:
                ...
                Picasso.get().load(ATPreferences.readString(FullScreenImage.this, Constants.KEY_IMAGE_URL) + detailsArray.get(preview_state).getProductImage()).fit().centerInside().placeholder(R.drawable.loading).into(imgDisplay);
            ...
            case R.id.ll_search:
                ...
                //Utils.showSearchDialog(this, "FullScreenImage");
                break;
        }
    }
