...
public class AdapterChildSpecials extends RecyclerView.Adapter<AdapterChildSpecials.ViewHolder> {
    ...
    private List<com.apitap.app.model.storeFrontSpecials.PCItem> arrayListItems;


    public AdapterChildSpecials(Context context, List<com.apitap.app.model.storeFrontSpecials.PCItem> pc,
    ...
    public void customNotify(List<com.apitap.app.model.storeFrontSpecials.PCItem> arrayListItems){
