...
public class AdapterParentAds extends BaseExpandableListAdapter {
    ...
    private List<com.apitap.app.model.storeFrontAds.RESULTItem> listParent;
    private List<PCItem> listChild;


    public AdapterParentAds(Context activity, List<com.apitap.app.model.storeFrontAds.RESULTItem> listItems,
    ...
    public void customNotify(ArrayList<com.apitap.app.model.storeFrontAds.RESULTItem> resultItems) {
