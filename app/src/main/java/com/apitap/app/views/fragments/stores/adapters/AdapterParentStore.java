package com.apitap.app.views.fragments.stores.adapters;
...
import com.apitap.app.model.storeCategories.RESULTItem;
...
public class AdapterParentStore extends BaseExpandableListAdapter {

    private AdapterStoreByCategory.StoreItemClick adapterClick;
    private Context context;
    private List<RESULTItem> listParent;
    private List<RESULTItem> listChild;

    public AdapterParentStore(Context context, List<RESULTItem> listItems, AdapterStoreByCategory.StoreItemClick itemListClick) {
    ...
    public Object getChild(int i, int i1) {
        return listParent.get(i).getME().get(i1);
    }
    ...
    public View getChildView(final int i, final int i1, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        AdapterStoreByCategory adapterChildItems =new AdapterStoreByCategory(context,listParent.get(i).getME(),adapterClick);
