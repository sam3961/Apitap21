package com.apitap.app.views.fragments.items.storeFront;
...
public class FragmentItemsStoreFront extends BaseFragment implements View.OnClickListener,
        ...
        AdapterParentCategoriesItem.ParentCategoryClick, SearchStoreClickListener, ViewTreeObserver.OnScrollChangedListener, View.OnTouchListener {

    private View rootView;

    private ImageView imageViewFilter;
    private ImageView imageViewStoreImage;
    private ImageView imageArrowIcon;
    ...
    private ArrayList<String> arrayListSpinnerCategoryId = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_item_storefront, container, false);
        return rootView;
    }
    ...
    private void initViews() {
        ...
        imageArrowIcon = rootView.findViewById(R.id.imageArrowIcon);
...
//            ((HomeActivity) getActivity()).fetchItemCategoryList(selectedCategoryId,false);
        }
*/
    ...
    private void setCategorySpinnerAdapter() {
        ...
        if (isFromStoreFront) {
            for (int i = 0; i < arrayListSpinnerCategory.size(); i++) {
                Log.d("merchantcatt", ATPreferences.readString(getActivity(), Constants.MERCHANT_CATEGORY));
                if (ATPreferences.readString(getActivity(), Constants.MERCHANT_CATEGORY).equalsIgnoreCase(arrayListSpinnerCategory.get(i))) {
                    spinnerSelectedCategoryId = arrayListSpinnerCategoryId.get(i);
            ...
            case Constants.ITEM_LIST_DATA:
                ...
                if (event.hasData()) {
                    if (getArguments() != null && getArguments().containsKey("key"))
                        ((HomeActivity) getActivity()).fetchItemCategoryList(searchKey, false);
                    //setItemListAdapter();
                    setItemListAdapter();
                    ...
                    if (adapterItems!=null)
                        adapterItems.customNotify(new ArrayList<>());
                    if (getArguments() != null && getArguments().containsKey("key"))
    ...
    public void onParentCategoryClick(final int position) {
        ...
        parentTitle = arrayListSelectParent.get(position).getTitle();
    ...
    private void inflateStoreCategorySpinnerList() {
        ...
        for (int i = 0; i < browseCategoryResponse.getRESULT().size(); i++) {
            ...
            arrayListSpinnerCategoryId.add(browseCategoryResponse.getRESULT().get(i).getJsonMember11493());
        }
    }
...
//                        Operations.getBrandNames(getActivity(), selectedUpdatedCategoryId, searchKey, merchantId));
...
//                        Operations.getRatingList(getActivity(), selectedUpdatedCategoryId, searchKey,
//                                ATPreferences.readString(getActivity(), Constants.MERCHANT_ID)));
    ...
    private void fetchDeliveryServices() {
      ...
      //  showProgress();
        ModelManager.getInstance().getMerchantStoresManager()
                .getDeliveryServices(getActivity(), Operations.getDeliveryServices(getActivity(), selectedUpdatedCategoryId, searchKey));
...
//                            spinnerSelectedCategoryId, searchKey,
//                            selectedDeliveryId, selectedParentId, merchantId));
//
//        } else
        String searchWord = "";
        if (getArguments() != null && getArguments().containsKey("key"))
    ...
    private void fetchItemsList() {
        ...
        ModelManager.getInstance().getItemManager().getItemCategoryItemsList
                (getActivity(), Operations.getCategoriesItemsList(getActivity(), selectedUpdatedCategoryId, searchKey, sortByID,
