...
import com.apitap.app.views.adapters.FavouriteSpecialGroupAdapter;
 ...
 */
public class FragmentFavoriteSpecials extends Fragment implements View.OnClickListener {
    ...
    private void initViews(View v) {
        ...
        mHeader.setText("Favorite Specials");
    ...
    private void setAdapter() {
        ...
        FavouriteSpecialGroupAdapter favouriteSpecialGroupAdapter = new FavouriteSpecialGroupAdapter(getActivity(),
                map_special, response_special,"");
        recyclerView.setAdapter(favouriteSpecialGroupAdapter);
