...
//merchantName
        ...
        if (getIntent().hasExtra("productId")) {
            ...
            data = (MessageListBean.MessageData) getIntent().getSerializableExtra("data");
...
//        });
        ...
        if (invoiceStr != null && !invoiceStr.isEmpty()) {
            ...
            ModelManager.getInstance().getMessageManager().getMessageDetail(this,
                    Operations.getMessageProduct(this, productId,messageId), Constants.MESSAGE_DETAIL_SUCCESS);
        ...
        switch (event.getKey()) {
            ...
            case Constants.FCM_MSG_NOTIFICATION:
                ...
                if (!MyFirebaseMessagingService.productId.isEmpty()) {
                    ModelManager.getInstance().getMessageManager().getMessageDetail(this,
                            Operations.getMessageProduct(this, MyFirebaseMessagingService.productId,MyFirebaseMessagingService.messageId), Constants.MESSAGE_DETAIL_SUCCESS);
    ...
    public static class MessageDetailAdapter extends RecyclerView.Adapter<MessageDetailAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            if (list.get(position).getUserId().equals(ATPreferences.readString(activity, Constants.KEY_USERID))) {
                ...
                if (list.get(position).getMiList().size() > 0) {
                    ...
                    if (list.get(position).getMiList().size() == 1) {
                        ...
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(0).getImageName()).into(holder.imageViewSender1);
                        ...
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(0).getImageName()).into(holder.imageViewSender1);
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(1).getImageName()).into(holder.imageViewSender2);
                        ...
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(1).getImageName()).into(holder.imageViewSender2);
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(2).getImageName()).into(holder.imageViewSender3);
                    }
                ...
                holder.txt_time.setText(Utils.getTimeFromInvoice(list.get(position).getCreatedDate()));
                ...
                if (list.get(position).getMiList().size() > 0) {
                    ...
                    if (list.get(position).getMiList().size() == 1) {
                        ...
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(0).getImageName()).into(holder.imageViewReceiver1);
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(1).getImageName()).into(holder.imageViewReceiver2);
                        ...
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(1).getImageName()).into(holder.imageViewReceiver2);
                        Picasso.get().load(ATPreferences.readString(activity, Constants.KEY_MESSAGE_IMAGE_URL) +
                                list.get(position).getMiList().get(2).getImageName()).into(holder.imageViewReceiver3);
                ...
                holder.txt_store_time.setText(" " + Utils.getTimeFromInvoice(list.get(position).getCreatedDate()));
