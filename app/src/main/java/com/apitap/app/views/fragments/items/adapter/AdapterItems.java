package com.apitap.app.views.fragments.items.adapter;
...
import com.apitap.app.model.itemModel.RESULT;
...
public class AdapterItems extends RecyclerView.Adapter<AdapterItems.ViewHolder> {
    ...
    public AdapterItems(Context context, List<RESULT> arrayListStores, ItemListClick adapterClick) {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        String ActualPrice = String.format("%.2f", Double.parseDouble(arrayListItems.get(position).get_11498()));
        String DiscountPrice = String.format("%.2f", Double.parseDouble(arrayListItems.get(position).get_122158()));
        ...
        holder.textViewItemName.setText(Utils.hexToASCII(arrayListItems.get(position).get_12083()));
        ...
        Picasso.get().load(ATPreferences.readString(context, Constants.KEY_IMAGE_URL)
                + "_t_" + arrayListItems.get(position).get_121170())
