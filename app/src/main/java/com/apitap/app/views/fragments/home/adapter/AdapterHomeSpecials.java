package com.apitap.app.views.fragments.home.adapter;
...
import com.apitap.app.model.home.specials.RESULTItem;
...
public class AdapterHomeSpecials extends RecyclerView.Adapter<AdapterHomeSpecials.ViewHolder> {
    private Context context;
    private SpecialListClick adapterClick;
    private List<RESULTItem> arrayListSpecials;

    public AdapterHomeSpecials(Context context, List<RESULTItem> arrayListStores, SpecialListClick adapterClick) {
...
*/
        ...
        Glide.with(context).load(ATPreferences.readString(context, Constants.KEY_IMAGE_URL)
                ...
                .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC).into(holder.imageViewItem);
