...
import com.apitap.app.model.bean.itemStoreFront.PCItem;
...
public class AdapterParentSpecials extends BaseExpandableListAdapter {

    private AdapterChildSpecials.SpecialListClick adapterClick;
    private Context context;
    private List<com.apitap.app.model.storeFrontSpecials.RESULTItem> listParent;
    private List<PCItem> listChild;

    public AdapterParentSpecials(Context context,
                                 List<com.apitap.app.model.storeFrontSpecials.RESULTItem> result,
                                 AdapterChildSpecials.SpecialListClick itemListClick) {
        this.listParent =result;
        this.context=context;
        this.adapterClick=itemListClick;
    }

    public void customNotify(ArrayList<com.apitap.app.model.storeFrontSpecials.RESULTItem> resultItems) {
    ...
    public View getChildView(final int i, final int i1, boolean b, View convertView, ViewGroup viewGroup) {
        ...
        AdapterChildSpecials adapterChildItems =new AdapterChildSpecials(context,listParent.get(i).getPC(),adapterClick);
